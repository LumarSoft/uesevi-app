"use client";
import { RectificarPreviewModule } from "@/modules/company/declaraciones/DeclaracionById/rectificar/preview";
import { fetchData } from "@/services/mysql/functions";
import { userStore } from "@/shared/stores/userStore";
import { IInfoDeclaracion } from "@/shared/types/Querys/IInfoDeclaracion";
import { useEffect, useState } from "react";

export default function RectificarPreviewPage({
  ...
  return <RectificarPreviewModule statement={statements} />;
} 